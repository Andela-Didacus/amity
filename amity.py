            ...
            if accomodation_status not in ["Y","N"]:
                ...
                if first_name.isalpha() and last_name.isalpha():
                    ...
                    if full_name in Amity.staff or full_name in Amity.fellows:
                        ...
                        if role == "STAFF":
                            Amity.allocate_staff_room(first_name, last_name, role, accomodation_status)
                        elif role == "FELLOW" and accomodation_status == "N":
                            Amity.allocate_fellow_with_no_accomodation(first_name, last_name, role, accomodation_status)
                        elif role == "FELLOW" and accomodation_status =="Y":
                            Amity.allocate_fellow_with_accomodation(first_name, last_name, role, accomodation_status)
                else:
               ...
               return "STAFF DOES'NT EXIST!!"
                ...
                for person in Amity.allocated_persons:
                        if person.full_name == full_name:
                            current_details_printer(full_name, person.office, person.living_space)
                            if room_name in Amity.living_spaces:
                                ...
                                Amity.allocated_persons.append(first_name)
                                Amity.allocated_rooms.append(living_space)
                                living_space_reallocator_printer(full_name, role, office, living_space)
                                return "ROOM SUCCESSFULLY ASSIGNED!!"
                                ...
                                Amity.allocated_persons.append(first_name)
                                Amity.allocated_rooms.append(living_space)
                                office_reallocator_printer(full_name, role, office, living_space)
                                return "ROOM SUCCESSFULLY ASSIGNED!!"
...
def printer_staff(full_name, role, office): #helper function to print staff info after assignment
...
def printer_fellow_N(full_name,role, office):#helper function to print fellow details
...
def printer_fellow_Y(full_name,role, office, living_space):#helper function to print fellow details
    print colored("\n*--*--*FELLOW SUCCESSFULLY ADDED*--*--*", "yellow")
    print colored("       -------------------------       ", "yellow")
    print "NAME: %s"%full_name
    print "ROLE: %s"%role
